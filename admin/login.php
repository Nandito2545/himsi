                                    ...
                                    <div class="card-body">
                                        <form method="post" action="">
                                            <div class="form-floating mb-3">
                                                <input name="txtuser" class="form-control" type="text" placeholder="Enter usrename" />
                                                <label >Username</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input name="txtpass" class="form-control" type="password" placeholder="Password" />
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Nandto Maulana Yedikar</div>
                            <div>
